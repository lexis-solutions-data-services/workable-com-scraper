"""
Example: How to call the workable-com-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/workable-com-scraper
...
def run_actor():
    """Run the workable-com-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/workable-com-scraper"
